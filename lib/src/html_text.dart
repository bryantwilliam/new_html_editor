...
import 'core/enums/input_action_enum.dart';
...
String getQuillPage({
  ...
  required String quillJsScript,
  required String fontFamily,
  required Color backgroundColor,
  required encodedStyle,
